                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            deputy.setAdresse(jsonObjectDeputy.getJSONArray("adresses")
                                    .getJSONObject(1).getString("adresse"));
                           deputy.setCollaborateurs(jsonObjectDeputy.getJSONArray("collaborateurs")
                                   .getJSONObject(0).getString("collaborateur"));
                           deputy.setResponsabilite(jsonObjectDeputy.getJSONArray("responsabilites")
                                    .getJSONObject(0).getJSONObject("responsabilite").getString("organisme"));
